...
with open(result_filename, 'a') as file: # Menggunakan mode 'a' agar menambahkan hasil running time ke file yang sudah ada
    ...
    #Perbedaannya ada di : ketika dec-app di jalankan , ngga langsung baca result.txt sebelum koneksi berhasil terhubung. lebih lancar. tp masi 1 persatu manual pemilihan algonya.