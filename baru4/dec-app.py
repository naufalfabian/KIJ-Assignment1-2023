...
rc4_iv = 0  # IV untuk RC harus berupa integer
...
# Baca nama file ciphertext yang diberikan oleh pengguna
ciphertext_filename = input("Masukkan nama file ciphertext yang ingin didekripsi: ")
...
# Simpan file yang sudah didekripsi dengan ekstensi yang sama dengan file asli
filename = os.path.splitext(ciphertext_filename)[0] + '_decrypted' + os.path.splitext(ciphertext_filename)[1]
