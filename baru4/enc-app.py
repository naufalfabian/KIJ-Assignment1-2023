...
# Tulis ciphertext ke file baru dengan ekstensi yang sama dengan file asli
ciphertext_filename = os.path.splitext(filename)[0] + '_encrypted' + os.path.splitext(filename)[1]
